var C=t=>{throw TypeError(t)};var b=(t,e,n)=>e.has(t)||C("Cannot "+n);var c=(t,e,n)=>(b(t,e,"read from private field"),n?n.call(t):e.get(t)),p=(t,e,n)=>e.has(t)?C("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,n),f=(t,e,n,r)=>(b(t,e,"write to private field"),r?r.call(t,n):e.set(t,n),n),O=(t,e,n)=>(b(t,e,"access private method"),n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function n(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=n(s);fetch(s.href,o)}})();const g={BASE_URL:"https://story-api.dicoding.dev/v1"},X=async(t,e,n)=>{const r=new Request(`${g.BASE_URL}/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:t,email:e,password:n})}),s=await fetch(r),o=await s.json();if(!s.ok)throw new Error((o==null?void 0:o.message)??"Gagal register akun");return o},ee=async(t,e)=>{var o;const n=new Request(`${g.BASE_URL}/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,password:e})}),r=await fetch(n),s=await r.json();if(!r.ok)throw new Error((s==null?void 0:s.message)??"Gagal masuk");return localStorage.setItem("token",(o=s==null?void 0:s.loginResult)==null?void 0:o.token),localStorage.setItem("user-data",JSON.stringify(s==null?void 0:s.loginResult)),document.getElementById("login-nav").classList.add("hidden"),document.getElementById("register-nav").classList.add("hidden"),document.getElementById("logout-button").classList.remove("hidden"),s},te=()=>{localStorage.removeItem("token"),document.getElementById("login-nav").classList.remove("hidden"),document.getElementById("register-nav").classList.remove("hidden"),document.getElementById("logout-button").classList.add("hidden"),window.location.hash="/login"},A=()=>!!localStorage.getItem("token"),x=()=>(A()||(window.location.hash="/login"),localStorage.getItem("token")??null),B=(t,e)=>e.some(n=>t instanceof n);let R,$;function ne(){return R||(R=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function se(){return $||($=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const I=new WeakMap,E=new WeakMap,v=new WeakMap;function re(t){const e=new Promise((n,r)=>{const s=()=>{t.removeEventListener("success",o),t.removeEventListener("error",a)},o=()=>{n(m(t.result)),s()},a=()=>{r(t.error),s()};t.addEventListener("success",o),t.addEventListener("error",a)});return v.set(e,t),e}function oe(t){if(I.has(t))return;const e=new Promise((n,r)=>{const s=()=>{t.removeEventListener("complete",o),t.removeEventListener("error",a),t.removeEventListener("abort",a)},o=()=>{n(),s()},a=()=>{r(t.error||new DOMException("AbortError","AbortError")),s()};t.addEventListener("complete",o),t.addEventListener("error",a),t.addEventListener("abort",a)});I.set(t,e)}let D={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return I.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return m(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function U(t){D=t(D)}function ae(t){return se().includes(t)?function(...e){return t.apply(P(this),e),m(this.request)}:function(...e){return m(t.apply(P(this),e))}}function ie(t){return typeof t=="function"?ae(t):(t instanceof IDBTransaction&&oe(t),B(t,ne())?new Proxy(t,D):t)}function m(t){if(t instanceof IDBRequest)return re(t);if(E.has(t))return E.get(t);const e=ie(t);return e!==t&&(E.set(t,e),v.set(e,t)),e}const P=t=>v.get(t);function F(t,e,{blocked:n,upgrade:r,blocking:s,terminated:o}={}){const a=indexedDB.open(t,e),l=m(a);return r&&a.addEventListener("upgradeneeded",i=>{r(m(a.result),i.oldVersion,i.newVersion,m(a.transaction),i)}),n&&a.addEventListener("blocked",i=>n(i.oldVersion,i.newVersion,i)),l.then(i=>{o&&i.addEventListener("close",()=>o()),s&&i.addEventListener("versionchange",u=>s(u.oldVersion,u.newVersion,u))}).catch(()=>{}),l}const ce=["get","getKey","getAll","getAllKeys","count"],de=["put","add","delete","clear"],S=new Map;function j(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(S.get(e))return S.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,s=de.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(s||ce.includes(n)))return;const o=async function(a,...l){const i=this.transaction(a,s?"readwrite":"readonly");let u=i.store;return r&&(u=u.index(l.shift())),(await Promise.all([u[n](...l),s&&i.done]))[0]};return S.set(e,o),o}U(t=>({...t,get:(e,n,r)=>j(e,n)||t.get(e,n,r),has:(e,n)=>!!j(e,n)||t.has(e,n)}));const le=["continue","continuePrimaryKey","advance"],q={},k=new WeakMap,V=new WeakMap,ue={get(t,e){if(!le.includes(e))return t[e];let n=q[e];return n||(n=q[e]=function(...r){k.set(this,V.get(this)[e](...r))}),n}};async function*me(...t){let e=this;if(e instanceof IDBCursor||(e=await e.openCursor(...t)),!e)return;e=e;const n=new Proxy(e,ue);for(V.set(n,e),v.set(n,P(e));e;)yield n,e=await(k.get(n)||e.continue()),k.delete(n)}function N(t,e){return e===Symbol.asyncIterator&&B(t,[IDBIndex,IDBObjectStore,IDBCursor])||e==="iterate"&&B(t,[IDBIndex,IDBObjectStore])}U(t=>({...t,get(e,n,r){return N(e,n)?me:t.get(e,n,r)},has(e,n){return N(e,n)||t.has(e,n)}}));const _="stories-db",T="stories";async function H(t){await(await F(_,1,{upgrade(n){n.createObjectStore(T,{keyPath:"id"})}})).put(T,t)}async function he(){return(await F(_,1)).getAll(T)}function G(t,e="en-US",n={}){return new Date(t).toLocaleDateString(e,{year:"numeric",month:"long",day:"numeric",...n})}var K=x();const pe=async()=>{const t=x(),e=await fetch(`${g.BASE_URL}/stories?page=1&size=16&location=1`,{method:"GET",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`}});return e.ok?e.json():await he()},ye=async t=>{const e=await fetch(`${g.BASE_URL}/stories/${t}`,{method:"GET",headers:{"Content-Type":"application/json",Authorization:`Bearer ${K}`}});if(!e.ok)throw new Error("Gagal mendapatkan data story");return e.json()},ge=async t=>{const e=new Request(`${g.BASE_URL}/stories`,{method:"POST",headers:{Authorization:`Bearer ${K}`},body:t}),n=await fetch(e);if(!n.ok)throw new Error("Gagal mendapatkan data story");return n.json()};class M{constructor(e){this.view=e}async handleFetchingStories(){try{this.view.setLoading(!0);const e=await pe();this.view.loadStories(e.listStory)}catch(e){console.error(e)}finally{this.view.setLoading(!1)}}async handleFetchStoryById(e){try{this.view.setLoading(!0);const n=await ye(e);this.view.loadStory(n.story)}catch(n){console.error(n)}finally{this.view.setLoading(!1)}}async handlePostStory(e){try{this.view.setLoading(!0);const n=await ge(e);this.view.redirectToHomePage()}catch(n){console.error(n.message)}finally{this.view.setLoading(!1)}}}class fe{async render(){return`
    ...
    `}async afterRender(){new M(this).handleFetchStoryById(this.id),document.getElementById("save-offline-btn").addEventListener("click",async()=>{this.storyData&&(await H({id:this.storyData.id,title:this.storyData.name,body:this.storyData.description}),alert("Story disimpan offline!"))})}loadMap(e){this.map=L.map("map").setView(e,8),L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19,attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'}).addTo(this.map)}async setLoading(e){}async loadStory(e){this.storyData=e,document.getElementById("post-photo").innerHTML=`<img src="${e.photoUrl}" alt="${e.name}'s Photo">`,document.getElementById("post-description").innerHTML=`
        ...
        `,this.loadMap([e.lat,e.lon]),this.marker=L.marker([e.lat,e.lon]).addTo(this.map).bindPopup(`<b>Description: </b><br />${e.description}`)}}const Y={"/":new fe,"/about":new we,"/login":new ve,"/register":new be,"/create-story":new Le,"/detail/:id":new Be};var y,h,d,w,Q;class Ie{constructor({navigationDrawer:e,drawerButton:n,content:r}){p(this,w);p(this,y,null);p(this,h,null);p(this,d,null);f(this,y,r),f(this,h,n),f(this,d,e),O(this,w,Q).call(this)}async renderPage(){const e=Z(),n=Y[e];c(this,y).innerHTML=await n.render(),await n.afterRender()}}y=new WeakMap,h=new WeakMap,d=new WeakMap,w=new WeakSet,Q=function(){c(this,h).addEventListener("click",()=>{c(this,d).classList.toggle("open")}),document.body.addEventListener("click",e=>{!c(this,d).contains(e.target)&&!c(this,h).contains(e.target)&&c(this,d).classList.remove("open"),c(this,d).querySelectorAll("a").forEach(n=>{n.contains(e.target)&&c(this,d).classList.remove("open")})})};document.addEventListener("DOMContentLoaded",async()=>{await new Ie({content:document.querySelector("#main-content"),drawerButton:document.querySelector("#drawer-button"),navigationDrawer:document.querySelector("#navigation-drawer")}).renderPage();let e=null;window.addEventListener("hashchange",async()=>{var a;const n=Z(),r=Y[n],s=r,o=document.querySelector("#main-content");e!=null&&e.stopCamera&&e.stopCamera(),e=r,document.startViewTransition?document.startViewTransition(async()=>{var l;o.innerHTML=await s.render(),await((l=s.afterRender)==null?void 0:l.call(s))}):(o.innerHTML=await s.render(),await((a=s.afterRender)==null?void 0:a.call(s)))}),A()?(document.getElementById("login-nav").classList.add("hidden"),document.getElementById("register-nav").classList.add("hidden"),document.getElementById("logout-button").classList.remove("hidden")):(document.getElementById("login-nav").classList.remove("hidden"),document.getElementById("register-nav").classList.remove("hidden"),document.getElementById("logout-button").classList.add("hidden")),document.getElementById("logout-button").addEventListener("click",()=>{te()});try{await Notification.requestPermission()==="granted"&&await Te()}catch(n){console.error("Error requesting notification permission:",n)}});const De="BKn_IwN-2Gf7mBkiihT7Ywd0-lnpErDuG0SMnUdCGlCuZ1M81PML-Jl8AhEXRuO8l_xU89i7-NrQf0SBuFKFDPo",Pe="https://story-api.dicoding.dev/v1/notifications/subscribe";function ke(t){const e="=".repeat((4-t.length%4)%4),n=(t+e).replace(/-/g,"+").replace(/_/g,"/"),r=window.atob(n),s=new Uint8Array(r.length);for(let o=0;o<r.length;++o)s[o]=r.charCodeAt(o);return s}async function Te(){const t=x();if("serviceWorker"in navigator&&"PushManager"in window)try{const n=await(await navigator.serviceWorker.ready).pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:ke(De)});(await fetch(Pe,{method:"POST",body:JSON.stringify({endpoint:n.endpoint,keys:JSON.parse(JSON.stringify(n)).keys}),headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`}})).ok?console.log("Push notification subscription successful"):console.error("Server rejected push subscription")}catch(e){console.error("Error subscribing to push notifications:",e)}}document.addEventListener("click",function(t){if(t.target.matches('button[aria-label="Simpan story ke offline"]')){const e={id:t.target.dataset.storyId||Date.now(),title:t.target.dataset.storyTitle||"Judul Story",body:t.target.dataset.storyBody||"Isi Story"};saveStoryToIndexedDB(e)}});window.saveStoryToIndexedDB=async function(t){await H(t),alert("Story disimpan untuk offline!")};
